...
public enum ErrorType {
    ...
    PRODUCT_ALREADY_EXISTS(1002,"This product has already been registered...",HttpStatus.BAD_REQUEST),  EMAIL_OR_PASSWORD_NOT_EXISTS(1003, "Email or password incorrect...",HttpStatus.BAD_REQUEST),
    PHONE_NUMBER_ALREADY_EXISTS(1004,"This phone number has already been registered...",HttpStatus.BAD_REQUEST),
    CUSTOMER_NOT_FOUND(1005,"Customer not found...",HttpStatus.BAD_REQUEST),
    PRODUCT_ALREADY_DELETED(1006,"This product has already been deleted...",HttpStatus.BAD_REQUEST),
    ACTIVATION_CODE_MISMATCH(1007,"Activation code incorrect...",HttpStatus.BAD_REQUEST),
    PRODUCT_NOT_ACTIVE(1008,"Product is not active" ,HttpStatus.BAD_REQUEST),
    ...
    ORDER_NOT_FOUND(4088,"Order not found..." ,HttpStatus.BAD_REQUEST),
    CART_NOT_FOUND(4001,"Cart name not found..." ,HttpStatus.BAD_REQUEST),
    PRODUCT_NOT_FOUND(4004,"Product not found..." ,HttpStatus.BAD_REQUEST),
    PRODUCT_NOT_REMOVED(4005,"Product not removed..." ,HttpStatus.BAD_REQUEST),
